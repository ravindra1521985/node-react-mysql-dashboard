    ...
    return (
            <nav className="navbar fixed-top navbar-expand-md navbar-dark bg-dark mb-3">
                <div className="flex-row d-flex">
                    ...
                    <a className="navbar-brand" href="javascript:;" title="Free Bootstrap 4 Admin Template">Record Book</a>
                </div>
                ...
                <div className="navbar-collapse collapse" id="collapsingNavbar">
                    <ul className="navbar-nav">
                        <li className="nav-item active">
                            <a className="nav-link" href="javascript:;">Home <span className="sr-only">Home</span></a>
                        </li>
                    ...
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item">
                            <a className="nav-link" href="javascript:;" data-toggle="collapse">Alert</a>
                        </li>
                        <li className="nav-item">
